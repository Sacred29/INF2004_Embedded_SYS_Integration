...
#define DEFAULT_UDP_RECVMBOX_SIZE 8 // Probably wont need this because im using TCP but havent test
#define DEFAULT_TCP_RECVMBOX_SIZE 8 // To get rid of ***PANIC*** size > 0 error

...
extern uint32_t adc_value; // External declaration of adc_value

void setup_ir(int GPIO_PIN, int ADC_NUM);
void sample_ir(int SAMPLING_INTERVAL_ms);
...
void sample_ir(int SAMPLING_INTERVAL_ms)
{
    ...
    add_repeating_timer_ms((SAMPLING_INTERVAL_ms), sampling_timer_function, NULL, &sampling_timer);
}
